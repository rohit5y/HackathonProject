...
public class LoanEMICalculator extends BasePage{
	
	public LoanEMICalculator(WebDriver driver) {
		super(driver);
	}
...
//	public void setLoanSlider() {
//		driver.switchTo().defaultContent();  // switch back to main page
//		Actions action = new Actions(driver);
//		textBoxValue1 = loanAmountTextBox.getAttribute("value");
//		action.dragAndDropBy(loanSlider,6 * baseClass.randomNumber(), 0).perform();
//		
//		textBoxValue2 = loanAmountTextBox.getAttribute("value");
...
//		Actions action = new Actions(driver);
//		textBoxValue1 = loanInterestTextBox.getAttribute("value");
//		action.dragAndDropBy(loanInterestSlider,(3 * baseClass.randomNumber() ), 0).perform();
//		
//		textBoxValue2 = loanInterestTextBox.getAttribute("value");
//		System.out.println(textBoxValue1);
//		System.out.println(textBoxValue2);
//	}
...
//		boolean check = loanTenureYearButton.isSelected();
//		System.out.println(check + " Year Button");
		JavascriptExecutor js = (JavascriptExecutor)driver;
